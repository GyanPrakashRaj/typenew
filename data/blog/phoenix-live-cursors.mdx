---
title: Searching and sorting Algorithm
...
We have to find out where it is. By looking at the above array, ‘21’ is present at index 5.

For example, you have some books on a shelf. They are not sorted. And you are searching for a book. So, you have to look at the books one by one until you find the book that you are searching for. So same process we will adopt here.
