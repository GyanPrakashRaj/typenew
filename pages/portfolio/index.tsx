...
export default function Blog({
  ...
  return (
    <Container
      title="Portolio – Gyan Prakash Raj"
      description="I've been a freelance web dev since 2019 and I've been involved in all sorts of projects. Here you'll find some of my most recent clients."
    >
