...
export default function Container(props) {
  ...
  const meta = {
    title: 'Gyan Prakash Raj – Full-Stack Developer',
    description: `Passionate & entrepreneurial Full-Stack developer from the Bihar`,
  ...
  return (
    <div className="bg-gray-100 dark:bg-gray-900">
      <Head>
        ...
        <meta property="og:site_name" content="Gyan Prakash Raj" />
